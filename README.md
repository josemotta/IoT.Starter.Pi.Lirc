...
There are more details about Lirc installation at [RPI Setup instructions](https://github.com/josemotta/IoT.Starter.Pi.Lirc/blob/master/RPI_Setup.md) available in the project repo. Following is a quick check to evaluate if Lirc installation is fine.
