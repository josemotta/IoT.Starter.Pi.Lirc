...
There are detailed instructions about Lirc installation at [RPI Setup](https://github.com/josemotta/IoT.Starter.Pi.Lirc/blob/master/RPI_Setup.md) contained in the project repo. Following is a quick check to evaluate if Lirc installation is fine.
